...
class _AdminStaffDirectoryViewState extends ConsumerState<AdminStaffDirectoryView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFFFAFBFE).withOpacity(0.92),
        elevation: 0,
        ...
        title: Row(
          children: [
            ...
            Column(
              ...
              children: [
                const Text('Staff Directory', style: TextStyle(fontFamily: 'Clash Display', fontSize: 18, fontWeight: FontWeight.w700, color: Color(0xFF140E28))),
                const Text('Manage all employees', style: TextStyle(fontFamily: 'Satoshi', fontSize: 11, fontWeight: FontWeight.w600, color: Color(0xFF7B7291))),
              ],
            ),
          ],
        ),
        ...
        data: (data) {
          ...
          return Column(
            children: [
              // Search & Filter Bar
              Container(
                color: const Color(0xFFFAFBFE).withOpacity(0.92),
