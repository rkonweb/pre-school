      ...
      child: SafeArea(bottom: false, child: Column(children: [
        ...
        SizedBox(height: 86, child: ListView(
          ...
          children: [
            ...
            _Chip('2', 'Comp-Off', 'Available', const Color(0xFFFFF7ED), const Color(0xFFF59E0B), const Color(0x33F59E0B)),
          ],
        )),
    ...
    return Padding(padding: const EdgeInsets.symmetric(horizontal:18),
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: _tA.withOpacity(.1), blurRadius:24, offset: const Offset(0,6))]),
        child: Column(children: [
          // ── Gradient header ───────────────────────────────────────────────
          Container(
          ...
          Padding(padding: const EdgeInsets.fromLTRB(10,10,10,4),
            child: Row(children: dayNames.asMap().entries.map((e) => Expanded(child: Center(child: Text(e.value,
              style: TextStyle(fontFamily:'Satoshi', fontSize:10, fontWeight:FontWeight.w800,
                color: e.key >= 5 ? const Color(0xFFEF4444).withOpacity(.7) : _ink3))))).toList())),
                          ...
                          child: Center(child: Container(
                            ...
                            decoration: isSel
                                ? BoxDecoration(gradient: _tGrad, shape: BoxShape.circle,
                                    boxShadow: [BoxShadow(color: _tA.withOpacity(.35), blurRadius:8, offset: const Offset(0,2))])
                                : (isToday
                                    ...
                                    : isPast
                                        ...
                                        : isToday
                                            ...
                                            : inRange
                                                ? _tA.withOpacity(.9)
                                                : isWknd
                                                    ? const Color(0xFFEF4444).withOpacity(.7)
                                                    : _ink)),
                              // Today dot
                              if (isToday && !isSel)
