  ...
  Future<void> _submit() async {
    ...
    if (_targetRoles.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Please select at least one target role')));
      return;
    }
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ModulePageHeader(
          ...
          actionLabel: _isLoading ? '...' : 'Post',
          onAction: _isLoading ? null : _submit,
        ),
        Expanded(
            child: Form(
          key: _formKey,
          child: ListView(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration:
                    _inputDecoration('Subject (Optional)', 'Brief summary'),
              ...
              Row(
                children: ['NORMAL', 'IMPORTANT', 'URGENT']
                    .map((p) => Expanded(
                          child: Padding(
              ...
              Wrap(
                spacing: 8,
                children: ['GENERAL', 'ACADEMIC', 'EVENT', 'EXAM', 'HOLIDAY']
                    .map((c) => ChoiceChip(
                          label: Text(c,
                              style: TextStyle(
                                  fontSize: 10,
  ...
  InputDecoration _inputDecoration(String label, String hint) {
    return InputDecoration(
      ...
      hintStyle: const TextStyle(
          fontFamily: 'Satoshi', color: Color(0xFFCBD5E1), fontSize: 14),
      filled: true,
