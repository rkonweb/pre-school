  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Colors.white.withOpacity(0.3), width: 1), // inner shadow simulation
        boxShadow: const [
          BoxShadow(
              ...
              Column(
                ...
                children: [
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: Colors.white,
                            boxShadow: [
                              BoxShadow(color: Colors.white.withOpacity(0.8), blurRadius: 12),
                              BoxShadow(color: Colors.white.withOpacity(0.3), spreadRadius: 3),
                            ],
                          ),
                  ...
                  Row(
                    ...
                    children: [
                      Text('0%', style: TextStyle(fontSize: 10.5, fontWeight: FontWeight.w600, color: Colors.white.withOpacity(0.6))),
                      Text('${(progress * 100).toStringAsFixed(1)}%', style: const TextStyle(fontSize: 10.5, fontWeight: FontWeight.w800, color: Colors.white)),
                      Text('100%', style: TextStyle(fontSize: 10.5, fontWeight: FontWeight.w600, color: Colors.white.withOpacity(0.6))),
                    ],
                  ),
                ],
              ),
