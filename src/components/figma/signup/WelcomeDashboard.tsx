...
export function WelcomeDashboard() {
  ...
  useEffect(() => {
    ...
    setSchoolName(schoolInfo.name || "Your School");
  }, []);
                  ...
                  {upcomingTasks.map((task, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex items-center gap-3 p-3 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors cursor-pointer">
                        ...
                        <span className={`ml-auto text-xs px-2 py-0.5 rounded-full font-medium ${task.priority === "high" ? "bg-red-100 text-red-700" :
