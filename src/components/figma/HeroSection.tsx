            ...
            >
              ...
              >
                <Link href="/signup">
                  <Button
                    size="lg"
                    className="relative bg-gradient-to-r from-teal-400 to-cyan-500 text-slate-900 hover:from-teal-500 hover:to-cyan-600 px-8 py-6 text-base md:text-lg shadow-2xl shadow-teal-500/50 font-bold group overflow-hidden w-full"
                  >
