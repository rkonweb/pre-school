...
export function ContactClient() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
            ...
            <section id="contact-form" className="py-20 px-4 bg-gradient-to-br from-slate-50 to-white">
                <div className="container mx-auto max-w-2xl text-center">
                    ...
                    >
                        ...
                        <div className="bg-white rounded-3xl shadow-xl border-2 border-slate-100 p-8 md:p-10 text-left">
                            {!isSubmitted ? (
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3.5 rounded-xl border-2 ${errors.fullName ? "border-red-300 bg-red-50" : "border-slate-200 bg-white"
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                onChange={handleInputChange}
                                                className={`w-full px-4 py-3.5 rounded-xl border-2 ${errors.interestedIn ? "border-red-300 bg-red-50" : "border-slate-200 bg-white"
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full py-4 px-6 bg-gradient-to-r from-amber-400 to-yellow-500 hover:from-amber-500 hover:to-yellow-600 text-slate-900 font-bold rounded-xl transition-all shadow-lg hover:shadow-xl active:scale-95 flex items-center justify-center gap-2"
                                    >
            ...
            <section className="py-20 px-4 bg-gradient-to-br from-teal-50 to-cyan-50 text-center">
                <div className="container mx-auto max-w-6xl">
                    <motion.div
                        initial={{ opacity: 0, y: 30 }}
                        whileInView={{ opacity: 1, y: 0 }}
                            ...
                            {whyChooseUs.map((item, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        whileHover={{ y: -4 }}
                                    >
                                        <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-teal-100 to-cyan-100 flex items-center justify-center mb-4 mx-auto">
            ...
            <section className="py-20 px-4 text-center">
                <div className="container mx-auto max-w-6xl">
                    <motion.div
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        <div className="bg-gradient-to-br from-slate-100 to-slate-200 rounded-3xl p-12 shadow-xl border-2 border-slate-200">
            ...
            {/* Final CTA Section */}
            <section className="py-20 px-4 bg-gradient-to-br from-slate-900 to-slate-800 text-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <button
                                ...
                                className="px-8 py-4 bg-gradient-to-r from-amber-400 to-yellow-500 hover:from-amber-500 hover:to-yellow-600 text-slate-900 font-bold rounded-xl transition-all shadow-lg hover:shadow-xl active:scale-95 flex items-center gap-2"
                            >
