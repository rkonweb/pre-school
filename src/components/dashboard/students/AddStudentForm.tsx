        ...
        <form onSubmit={handleSubmit} className="flex h-full flex-col gap-6">
            ...
            <div className="mt-auto flex items-center justify-end gap-3 pt-6 border-t border-zinc-200 dark:border-zinc-800">
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="inline-flex items-center justify-center rounded-lg bg-brand px-4 py-2 text-sm font-medium text-[var(--secondary-color)] transition-colors hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed dark:focus:ring-offset-zinc-900"
                >
