...
export function Sidebar({ schoolName, logo, user, enabledModules = [] }: {
    ...
    const rawNavigation: NavItem[] = [
        ...
        {
            name: "Academics", href: `/s/${slug}/academics`, icon: BookOpen,
            children: [
    ...
    const navPermissionMap: Record<string, string> = {
        ...
        "Progress Reports": "students.performance",
        ...
        "Programs Dashboard": "extracurricular",
        "Activity Master": "extracurricular",
        "Clubs & Academies": "extracurricular",
        "Student Enrollment": "extracurricular",
        "Activity Timetable": "extracurricular",
        "Attendance Tracking": "extracurricular",
        "Performance Eval": "extracurricular",
        "Events & Awards": "extracurricular",
        "Equipment & Gear": "extracurricular",
        "Accounts": "accounts",
        "Financial Dashboard": "accounts",
        "Fee Management": "billing",
        "Transactions": "accounts",
        "Vendors & Payees": "accounts",
        "Bulk Fee Actions": "billing",
        "Purchase Orders": "accounts",
        "Quotations": "accounts",
        "AI Insights": "accounts",
        ...
        "Student List": "transport",
        "Fleet – Vehicles": "transport.fleet",
        "Fleet – Drivers": "transport.fleet",
        "Fleet – Assignments": "transport.fleet",
        "GPS Tracking": "transport.tracking",
        "Applications": "transport",
        "Transport Fees": "transport",
        "Daily Reports": "transport",
        "Monthly Reports": "transport",
        "Expense Tracking": "transport",
        "Application Requests": "transport",
        "Application Status": "transport",
        "Fee Generation": "transport",
        "Library": "library",
        "Library Dashboard": "library",
        "Issue & Return": "library",
        "Book Inventory": "library",
        "Library Transactions": "library",
        "Canteen": "canteen",
        "Dashboard & AI": "canteen",
        "Point of Sale": "canteen",
        "Menu & Timetable": "canteen",
        "Meal Packages": "canteen",
        "Subscriptions": "canteen",
        "Accounts Ledger": "canteen",
        "Hostel Management": "hostel",
        "Room Allocation": "hostel",
        "Hostel Billing": "hostel",
        "Hostel Settings": "hostel",
        "School Store": "store",
        "Store Dashboard": "store",
        "Orders": "store",
        "Academic Packages": "store",
        "Catalog": "store",
        ...
        "System Access Control": "settings",
        "Branch Management": "settings",
        "Identifiers": "settings",
        "Attendance & Leaves": "settings",
        "Payroll & Disbursement": "settings",
        "Biometric Integration": "settings",
        "Location & Physicality": "settings",
        "Connectors & APIs": "settings",
        "Subscription & Plan": "settings",
        "ID Card Templates": "settings",
        "Regional Operations": "settings",
        "Development Settings": "settings",
