...
export function Header({ schoolTimezone }: { schoolTimezone?: string }) {
        ...
        <header className="sticky top-0 z-40 flex h-16 w-full items-center justify-between border-b border-zinc-200 bg-white px-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-zinc-50 border border-zinc-100 rounded-xl">
                        <ClockIcon className="h-3.5 w-3.5 text-brand" />
                        <span className="text-xs font-black text-zinc-600 tabular-nums">
                            {currentTime || "--:-- --"}
                        </span>
                    </div>
                </div>
