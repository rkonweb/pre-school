    ...
    if (success) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-zinc-50 p-6">
                <div className="max-w-md w-full bg-white rounded-[48px] p-12 shadow-2xl text-center space-y-8 animate-in fade-in zoom-in duration-500">
                    <div className="h-24 w-24 bg-blue-600 rounded-[32px] flex items-center justify-center mx-auto shadow-xl shadow-blue-200">
                    ...
                    <div>
                        ...
                        <p className="text-zinc-500 font-medium mt-3 leading-relaxed">
                            Thank you for completing the comprehensive admission form for <span className="text-blue-600 font-bold">{admission.studentName}</span>.
            ...
            <header className="bg-white border-b border-zinc-100 px-6 py-6 sticky top-0 z-50 backdrop-blur-md bg-white/80">
                <div className="max-w-4xl mx-auto flex items-center justify-between">
                    ...
                    <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-full border border-blue-100">
                        ...
                        <span className="text-[10px] font-black text-blue-700 uppercase tracking-widest">Secure Link Active</span>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-4xl mx-auto p-6 pt-12 pb-24">
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                    ...
                    <div className="bg-white rounded-[40px] p-10 border border-zinc-100 shadow-xl shadow-zinc-200/20">
                        ...
                        <div className="grid sm:grid-cols-2 gap-8 ring-1 ring-zinc-50 p-6 rounded-[32px]">
                        ...
                        <div className="grid sm:grid-cols-3 gap-8 mt-10">
                            <div className="sm:col-span-1">
                                ...
                                <select
                                    ...
                                    className="w-full bg-zinc-50 border-2 border-transparent focus:border-blue-600 focus:bg-white rounded-[24px] py-4 px-6 font-bold transition-all outline-none"
                                >
                    ...
                    <div className="bg-white rounded-[40px] p-10 border border-zinc-100 shadow-xl shadow-zinc-200/20">
                        ...
                        <div className="grid gap-4">
                            {[
                                ...
                                <div key={idx} className="group p-6 rounded-[28px] bg-zinc-50 border-2 border-dashed border-zinc-100 hover:border-blue-600/30 hover:bg-blue-50/20 transition-all flex items-center justify-between cursor-pointer">
                                    <div className="flex items-center gap-4">
                                        <div className="h-10 w-10 bg-white rounded-xl flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">
                                            <FileUp className="h-5 w-5 text-zinc-400 group-hover:text-blue-600" />
                                        </div>
                                        <div>
                    ...
                    <div className="flex flex-col items-center gap-6 pt-10">
                        ...
                        <button
                            type="submit"
                            disabled={isSaving}
                            className="w-full max-w-sm h-20 bg-blue-600 text-white rounded-[32px] font-black text-lg flex items-center justify-center gap-4 shadow-2xl shadow-blue-200 hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50"
                        >
    ...
    return (
        <div className="space-y-2">
            ...
            <input
                ...
                className="w-full h-16 bg-zinc-50 border-2 border-transparent focus:border-blue-600 focus:bg-white rounded-[24px] px-8 font-bold transition-all outline-none text-sm placeholder:text-zinc-300 shadow-sm"
            />
        </div>
    );
}
