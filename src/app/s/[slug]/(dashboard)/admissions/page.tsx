...
import { AdmissionBoard } from "@/components/dashboard/admissions/AdmissionBoard";
        ...
        return (
            <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="h-12 w-32 bg-zinc-100 animate-pulse rounded-2xl" />
                </div>
                <DashboardLoader message="Loading admissions pipeline..." className="h-[60vh]" />
            </div>
        );
    }
                    ...
                    <div className="bg-white rounded-[32px] p-8 border border-zinc-100 shadow-xl shadow-zinc-200/20">
                        <div className="flex items-center justify-between mb-8">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="font-black text-sm uppercase tracking-widest text-zinc-900">Marketing Attribution</h3>
                                    <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mt-1">Lead volume by source</p>
                                </div>
                            </div>
                            <button
                                onClick={() => setShowSourceChart(false)}
                                className="h-8 px-4 bg-zinc-100 text-zinc-500 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-zinc-200 transition-all"
                            >
                                Hide
                            </button>
                        </div>
                        <AdmissionSourceChart data={sourceStats} />
                    </div>
                )}

                {/* Pipeline Content */}
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-zinc-200 dark:border-zinc-800 pb-px">
                        ...
                        <div className="flex items-center gap-1 bg-zinc-100 p-1 rounded-xl shrink-0 self-end sm:self-center mb-2 sm:mb-0">
                            <button
                                onClick={() => setViewType("board")}
                                className={cn(
                                    "h-8 px-3 rounded-lg flex items-center gap-2 text-[10px] font-black uppercase tracking-widest transition-all",
                                    viewType === "board" ? "bg-white text-zinc-900 shadow-sm" : "text-zinc-400 hover:text-zinc-600"
                                )}
                            >
                            ...
                            <button
                                ...
                                className={cn(
                                    "h-8 px-3 rounded-lg flex items-center gap-2 text-[10px] font-black uppercase tracking-widest transition-all",
                                    viewType === "table" ? "bg-white text-zinc-900 shadow-sm" : "text-zinc-400 hover:text-zinc-600"
                                )}
                            >
                            ...
                            >
                                ...
                                {showSourceChart ? "Hide Insights" : "Insights"}
                            </button>
                        </div>
                    </div>
