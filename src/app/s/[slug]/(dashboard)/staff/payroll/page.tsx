        ...
        <div className="p-8 space-y-8 animate-in fade-in duration-700 max-w-[1600px] mx-auto">
                ...
                {view === "LIST" ? (
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className="bg-blue-600 dark:bg-zinc-50 text-white dark:text-zinc-900 px-8 py-4 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] flex items-center gap-2 shadow-2xl shadow-zinc-900/20 transition-all hover:-translate-y-1 hover:shadow-emerald-500/10 active:scale-95 disabled:opacity-50"
                        >
                    ...
                    {payrolls.map((p) => (
                        ...
                        >
                            <div className="flex items-start justify-between mb-8">
                                <div className="p-4 bg-blue-600 dark:bg-white rounded-3xl text-white dark:text-zinc-900 shadow-xl shadow-zinc-900/10 transition-transform group-hover:scale-110">
            ...
            {view === "DETAILS" && selectedPayroll && (
                <div className="space-y-10 animate-in slide-in-from-bottom-8 duration-700">
                    ...
                    {/* Action Bar */}
                    <div className="bg-blue-600 dark:bg-zinc-950 text-white rounded-[3rem] p-10 flex flex-col lg:flex-row gap-10 items-center justify-between shadow-3xl shadow-zinc-900/40 relative overflow-hidden group">
                                                ...
                                                <td className="px-10 py-8 text-right">
                                                    <div className="flex items-center justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity translate-x-4 group-hover:translate-x-0">
                                                        <button
                                                            ...
                                                            className="h-12 w-12 flex items-center justify-center bg-blue-600 dark:bg-white text-white dark:text-zinc-900 rounded-2xl shadow-xl transition-all hover:scale-110 active:scale-90"
                                                        >
                ...
                {selectedPayslip && (
                    <div className="space-y-12 pb-10">
                        ...
                        <div className="text-center space-y-4">
                            <div className="h-32 w-32 rounded-[3rem] bg-blue-600 mx-auto flex items-center justify-center text-white text-3xl font-black italic shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] border-4 border-white">
                        ...
                        <div className="pt-10 flex gap-4">
                            <button
                                onClick={handlePrint}
                                className="flex-1 bg-blue-600 text-white hover:bg-blue-700 py-6 rounded-[1.5rem] font-black uppercase tracking-[0.2em] text-xs flex items-center justify-center gap-3 shadow-3xl shadow-zinc-900/20 transition-all hover:-translate-y-1 active:scale-95 border-b-4 border-black"
                            >
                                <Printer className="h-5 w-5" />
    ...
    return (
        <div className="max-w-[800px] mx-auto p-12 bg-white text-zinc-900 font-sans border border-zinc-200">
            ...
            <div className="flex justify-between items-start border-b-4 border-zinc-900 pb-10 mb-10">
                <div className="space-y-4">
                    {school?.logo ? (
                        ...
                        <div className="h-20 w-20 bg-blue-600 flex items-center justify-center text-white text-3xl font-black">{school?.name?.[0]}</div>
                    )}
                    <div>
                ...
                <div className="text-right flex flex-col items-end gap-3 pt-4">
                    <div className="bg-blue-600 text-white hover:bg-blue-700 px-8 py-3 rounded-xl font-black uppercase tracking-[0.2em] text-[10px]">Payslip Archive</div>
            ...
            <div className="grid grid-cols-2 gap-10 mb-12">
                ...
                <div className="p-10 bg-blue-600 text-white hover:bg-blue-700 rounded-[2.5rem] flex flex-col justify-between shadow-2xl">
                    <div className="space-y-1">
