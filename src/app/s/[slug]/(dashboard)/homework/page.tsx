                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 rounded-lg bg-zinc-900 border border-zinc-700 text-white text-sm focus:border-red-500 focus:outline-none"
                                            placeholder="https://..."
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 rounded-lg bg-zinc-900 border border-zinc-700 text-white text-sm focus:border-purple-500 focus:outline-none"
                                            placeholder="https://..."
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 rounded-lg bg-zinc-900 border border-zinc-700 text-white text-sm focus:border-emerald-500 focus:outline-none"
                                            placeholder="https://..."
                                        />
                                    </div>
                                </div>
