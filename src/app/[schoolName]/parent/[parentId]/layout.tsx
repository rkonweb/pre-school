...
export default function ParentLayout({ children }: { children: React.ReactNode }) {
    ...
    const schoolName = typeof params.schoolName === 'string' ? params.schoolName : '';
    const phone = searchParams.get("phone") || "";

    return (
        <ParentProvider schoolName={schoolName} phone={phone}>
            <ParentLayoutContent>
                {children}
            </ParentLayoutContent>
        </ParentProvider>
...
function ParentLayoutContent({ children }: { children: React.ReactNode }) {
    ...
    const baseRoute = `/${schoolName}/parent/${parentId}`;
