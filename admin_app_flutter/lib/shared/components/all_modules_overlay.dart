...
class AllModulesOverlay extends ConsumerWidget {
  ...
  Widget _buildSearchBar() {
    return Container(
      ...
      child: const Row(
        children: [
          Icon(Icons.grid_view_rounded, size: 20, color: Color(0xFF94A3B8)),
          SizedBox(width: 12),
          Expanded(
            child: TextField(
  ...
  Widget _buildQuickActionItem(String label, IconData icon, Color color) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF140E28).withValues(alpha: 0.03),
            blurRadius: 10,
            offset: const Offset(0, 4),
          ),
        ],
  ...
  Widget _buildAdminModuleItem(BuildContext context, ModuleItem module) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF140E28).withValues(alpha: 0.02),
            blurRadius: 12,
            offset: const Offset(0, 4),
          ),
        ],
  ...
  Widget _buildFooter(BuildContext context, WidgetRef ref) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFF9FAFB).withValues(alpha: 0.95),
