      ...
      child: Column(
        ...
        children: [
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        _SparkBar(height: 0.55, color: Color(0xFFFF5733)),
                        _SparkBar(height: 0.65, color: Color(0xFFFF5733)),
                        _SparkBar(height: 0.70, color: Color(0xFFFF5733)),
                        _SparkBar(height: 0.68, color: Color(0xFFFF5733)),
                        _SparkBar(height: 0.73, color: Color(0xFFFF5733)),
                        _SparkBar(height: 0.82, color: Color(0xFFFF006E)),
                      ],
                    ),
                  ),
                ],
          ...
          const _TopPerformerRow(
            ...
            name: 'Sneha Patil',
            score: '91%',
            gradient: LinearGradient(colors: [Color(0xFFCD7F32), Color(0xFFA05A20)]),
          ),
        ],
      ),
    );
