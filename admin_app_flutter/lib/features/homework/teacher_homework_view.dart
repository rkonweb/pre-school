...
class _TeacherHomeworkViewState extends ConsumerState<TeacherHomeworkView> {
  ...
  void _openSheet() {
    setState(() {
      _dueDate = null; _selectedClassId = null; 
    ...
    showModalBottomSheet(
      ...
      builder: (_) => StatefulBuilder(builder: (ctx, setMs) {
        return _CreateSheet(
          ...
          onSetClass: (id, name) { setMs(() {}); setState(() { _selectedClassId = id; }); },
  ...
  PreferredSizeWidget _buildAppBar() => AppBar(
    ...
    actions: [
      GestureDetector(
        ...
        child: Container(margin: const EdgeInsets.only(right: 12), width: 38, height: 38,
    ...
    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Container(width: 72, height: 72,
        decoration: BoxDecoration(gradient: _tGrad, borderRadius: BorderRadius.circular(22),
          boxShadow: [BoxShadow(color: _tA.withValues(alpha: 0.3), blurRadius: 20, offset: const Offset(0, 8))]),
      ...
      GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(gradient: _tGrad, borderRadius: BorderRadius.circular(14),
            boxShadow: [BoxShadow(color: _tA.withValues(alpha: 0.35), blurRadius: 18, offset: const Offset(0, 6))]),
  ...
  Widget _buildFab() => GestureDetector(
    ...
    child: Container(width: 56, height: 56,
      decoration: BoxDecoration(gradient: _tGrad, borderRadius: BorderRadius.circular(18),
        boxShadow: [BoxShadow(color: _tA.withValues(alpha: 0.4), blurRadius: 16, offset: const Offset(0, 6))]),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (_expanded && widget.mode == _SheetMode.grade) ...[
          Container(height: 1, color: _line.withValues(alpha: 0.5)),
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(gradient: _tGrad, borderRadius: BorderRadius.circular(12),
                      boxShadow: [BoxShadow(color: _tA.withValues(alpha: 0.3), blurRadius: 12, offset: const Offset(0, 4))]),
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(width: double.infinity, padding: const EdgeInsets.all(14),
              decoration: BoxDecoration(color: _tSoft, borderRadius: BorderRadius.circular(14),
                border: Border.all(color: _tA.withValues(alpha: 0.35), width: 1.5)),
...
class _HomeworkCardState extends State<_HomeworkCard> with SingleTickerProviderStateMixin {
  ...
  Widget _btn(String label, {bool outlined = false}) => Container(
    ...
    decoration: BoxDecoration(
      ...
      border: outlined ? Border.all(color: _tA.withValues(alpha: 0.4), width: 1.5) : null),
    child: Text(label, style: TextStyle(fontFamily: 'Satoshi', fontSize: 10,
