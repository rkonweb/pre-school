...
class _State extends ConsumerState<TeacherProfileView>
            ...
            child: Row(children: [
              GestureDetector(
                ...
                child: Container(width: 32, height: 32,
                  decoration: BoxDecoration(color: Colors.white.withValues(alpha: .25),
  ...
  Widget _performanceTab(StaffProfile p) {
    ...
    const bars   = [72, 78, 75, 82, 80, 88, 91];
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('91%', style: TextStyle(fontFamily: 'Cabinet Grotesk',
            ...
            SizedBox(width: 36, child: Column(children: [
              Container(width: isCur ? 14 : 10, height: isCur ? 14 : 10,
                decoration: BoxDecoration(shape: BoxShape.circle, color: col,
                  boxShadow: isCur ? [BoxShadow(color: col.withValues(alpha: .3), blurRadius: 8)] : null)),
              if (i < timeline.length - 1) Container(width: 2, height: 36,
                margin: const EdgeInsets.symmetric(vertical: 4),
                decoration: BoxDecoration(
                  gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter,
                    colors: [col.withValues(alpha: .4), _line]))),
            ])),
      ...
      Container(padding: const EdgeInsets.all(14),
        ...
        child: Row(children: [
          const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('GROSS SALARY', style: TextStyle(fontFamily: 'Satoshi', fontSize: 9,
              fontWeight: FontWeight.w700, color: _ink3, letterSpacing: .4)),
            Text('₹52,000', style: TextStyle(fontFamily: 'Cabinet Grotesk',
              fontSize: 22, fontWeight: FontWeight.w900, color: _ink)),
          ])),
          Container(width: 1, height: 40, color: _line),
          const SizedBox(width: 14),
          const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('NET TAKE-HOME', style: TextStyle(fontFamily: 'Satoshi', fontSize: 9,
              fontWeight: FontWeight.w700, color: _ink3, letterSpacing: .4)),
            Text('₹44,850', style: TextStyle(fontFamily: 'Cabinet Grotesk',
  ...
  Widget _tog(String emoji, Color emojiBg, String title, String sub,
    ...
    GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          Container(width: 34, height: 34, alignment: Alignment.center,
            decoration: BoxDecoration(color: emojiBg.withValues(alpha: .15),
              borderRadius: BorderRadius.circular(11)),
            child: Text(emoji, style: const TextStyle(fontSize: 15))),
          const SizedBox(width: 11),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
