          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _selectedClass != null
                  ? AppTheme.teacherTheme.colors.first.withValues(alpha: 0.4)
                  : const Color.fromRGBO(20, 14, 40, 0.1),
              width: 1.5,
            ),
            boxShadow: const [BoxShadow(color: Color.fromRGBO(20, 14, 40, 0.05), blurRadius: 8, offset: Offset(0, 2))],
          ),
          child: Row(
            children: [
              ...
              if (_selectedClass != null)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: AppTheme.teacherTheme.colors.first.withValues(alpha: 0.1),
  ...
  Widget _buildDateChip() {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isToday ? AppTheme.teacherTheme.colors.first.withValues(alpha: 0.08) : Colors.white,
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: isToday ? AppTheme.teacherTheme.colors.first.withValues(alpha: 0.3) : const Color.fromRGBO(20, 14, 40, 0.1),
            width: 1.5,
          ),
        ),
        child: Column(
  ...
  Widget _buildPermissionBadge() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: _canMark ? const Color(0xFF16A34A).withValues(alpha: 0.3) : const Color(0xFFD97706).withValues(alpha: 0.3),
        ),
      ),
      child: Row(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: AppTheme.teacherTheme.colors.first.withValues(alpha: 0.3),
