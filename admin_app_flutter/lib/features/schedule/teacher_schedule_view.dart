                ...
                return Expanded(child: GestureDetector(
                  ...
                  child: Column(children: [
                    Text(_dayShorts[dk], style: TextStyle(
                      ...
                      color: isCur ? Colors.white : Colors.white.withValues(alpha: 0.6))),
                    ...
                    Column(children: pds.take(6).map((p) {
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          color: isCur ? _hexColor(c.bar) : Colors.white.withValues(alpha: 0.4),
                          borderRadius: BorderRadius.circular(3)),
                      );
                    }).toList()),
                    if (pds.isEmpty)
                      Container(height: 5, decoration: BoxDecoration(
                        color: Colors.white.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(3))),
        ...
        children: [
          ...
          SizedBox(width: 42, child: Column(children: [
            ...
            Expanded(child: Container(
              ...
              width: 2,
              color: isLive ? _tA.withValues(alpha: 0.7) : (isDone ? const Color(0xFFD1FAE5) : _line),
            )),
          ...
          Expanded(child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                ...
                width: isLive ? 2 : 1.5),
              boxShadow: isLive
                  ? [BoxShadow(color: _tA.withValues(alpha: 0.18), blurRadius: 20, offset: const Offset(0, 4))]
                    ...
                    Expanded(child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: _tA.withValues(alpha: 0.3), width: 1.5)),
...
class _BreakRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(children: [
      Expanded(child: Container(height: 1.5, color: _tA.withValues(alpha: 0.35))),
...
class _StatChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Expanded(child: Container(
    ...
    child: Column(children: [
      ...
      Text(label, style: const TextStyle(fontFamily: 'Satoshi', fontSize: 8, fontWeight: FontWeight.w700, color: _ink3, letterSpacing: 0.5)),
    ]),
  ));
}
